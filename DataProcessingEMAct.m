...
if measSet.force
    figure(1)
    plot(timeVec,forceData.Fz,timeVec,currData);
    legend('Measured axial force (N)','Current thru actuator (A)')
    xlabel('Time (s)')
    title("Axial force of the actuator, "+num2str(currPP,'%.2f')+" A p-p" )
end
